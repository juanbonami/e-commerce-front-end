...
import logo4 from '../images/blond-woman-with-winter-pine.jpg';
import logo5 from '../images/classy-tuxedo-fashion.jpg';
import logo6 from '../images/confident-young-woman.jpg';
...
export default class DefaultPage extends Component {
  ...
  <br />
  <Row>
    <Col className="body-text"> <img className="pic-border" src={logo4} height="400" width="480" alt=""></img> </Col>
    <Col className="body-text"> <img className="pic-border" src={logo5} height="400" width="480" alt=""></img> </Col>
    <Col className="body-text"> <img className="pic-border" src={logo6} height="400" width="480" alt=""></img> </Col>
  </Row>
</Container>
<Footer />
            </div>
